...
public class Map {
	...
	public void draw(MazePanel panel, int x, int y, int angle, int walkStep,
        ...
        graphicsPanel.drawMap(this, maze, x, y, walkStep, viewDX, viewDY, showMaze, showSolution) ;
        graphicsPanel.drawCurrentLocation(viewDX, viewDY) ;
	}
